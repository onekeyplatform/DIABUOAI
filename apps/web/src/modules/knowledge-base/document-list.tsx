export function DocumentList() {
  return (
    <section style={{ border: '1px solid #e5e7eb', borderRadius: 12, padding: 20, background: '#fff' }}>
      <h3 style={{ marginTop: 0 }}>Documents in Knowledge Base</h3>
      <table
        style={{
          width: '100%',
      ...
      >
        <thead>
          <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
            ...
            <th style={{ textAlign: 'left', padding: '12px 0', fontWeight: 600 }}>Chunks</th>
            <th style={{ textAlign: 'left', padding: '12px 0', fontWeight: 600 }}>Uploaded</th>
            <th style={{ textAlign: 'right', padding: '12px 0', fontWeight: 600 }}>Actions</th>
          </tr>
        </thead>
        <tbody>
          <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
            <td style={{ padding: '12px 0' }}>Sample Document</td>
